...
export interface SkillCategory {
  ...
  description: string;
  questions: MCQ[];
  resources: { [subskill: string]: LearningResource[] };
}
...
export const getAllCategories = () => Object.values(skillCategories);

export const getCategoryById = (id: string) => skillCategories[id];

export const getRandomMCQs = (categoryId: string, count: number = 3): MCQ[] => {
